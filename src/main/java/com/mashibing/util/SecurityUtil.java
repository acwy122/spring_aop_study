...
public class SecurityUtil {
    ...
    public static void stop(JoinPoint joinPoint,Object result){
        Signature signature = joinPoint.getSignature();
        System.out.println("Security---"+signature.getName()+"方法执行结束：参数是："+Arrays.asList(result));
    }
    ...
    public static void logException(JoinPoint joinPoint,Exception e){
        Signature signature = joinPoint.getSignature();
        System.out.println("Security---"+signature.getName()+"方法执行异常："+e);
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        Object result = null;
        try {
            System.out.println("Security---"+"环绕通知start"+signature.getName()+"开始执行，参数为："+Arrays.asList(args));
